...
# containing columns
# "Name" and "Age." Create a new CSV file called "adults.csv"
#  with only the rows of
...
INPUT_FILE = "data.csv"
OUTPUT_FILE = "adult.csv"

filter_adults(INPUT_FILE, OUTPUT_FILE)

# Create a function add_to_json that takes a
# filename and a dictionary as input. The
# function should read the JSON data
# from the file, add the new dictionary to it, and
...
# The function should find and display all lines
