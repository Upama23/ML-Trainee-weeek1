...
integers as input and performs division
(num1 / num2). Handle the ZeroDivisionError and
...
#  Implement a program that takes user input
# for a filename, opens the file in read
# mode, and displays its contents. Handle the
#  FileNotFoundError and display an error
...
#  Write a Python program that takes a user input
# and converts it to an integer. Handle
...
# as input and performs division (num1
# / num2). Handle both ValueError (if non-integer input)
#  and ZeroDivisionError and
...
def get_valid_age():
    ...
    try:
        age = 7
        if age < 0 or age > 120:
            raise InvalidAgeError("Invalid Age. Age between 0 and 120")
        return age
