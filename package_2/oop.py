...
# department name, head of the department, and a
# list of courses offered. Implement
...
class Department(University):
    ...
    def get_head_of_the_department(self):
...
if __name__ == "__main__":
    ...
    print(f"{customer1.name} has a {customer1.bank_account.account_type} ")
    print(f"account number {customer1.bank_account.account_number}")
    print(f"and balance {customer1.bank_account.balance}.")
    del customer1
